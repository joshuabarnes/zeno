...
/* Bits used to construct type of a node. */

#define CELL  001		/* node is cell of oct-tree */
#define BODY  002		/* node is any kind of body */
#define GAS   004		/* node is smooth hydro body */
#define STAR  010		/* node has become a star */
...
#define INCLUDE  001		/* include body in tree construction */
#define UPDATE   002		/* update body, or bodies within cell */
#define INQUE    004		/* body is listed in current priority que */
#define DONE     010		/* smoothing operation is complete */
#define SURFACE  020		/* body has optically thin neighbors */
...
typedef struct {
    ...
    real frequency;		/* inverse of time-step			    */
...
/* even though only a subset of these fields exist in any given version.    */
...
void report_force(stream, int);		/* report on force calculation      */

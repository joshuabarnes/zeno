...
string defv[] = {		";SPH/N-body simulation code.",
    ...
    "starseed=12345",		";Random seed for star processes",
#endif
    ...
    "options=",			";Assorted flags for simulation control.",
				";corrfunc, levelhist, new-tout, nolimit,",
				";fixstep, lockstep, reset-time, bh86, sw94.",
    ...
    "VERSION=1.3",		";Joshua Barnes  23 December 2009",
    NULL,
};

/*
...
#endif
#if defined(MASSLOSS)
    define_body_offset(AuxTag, BodyOffset(Death));	/* use Aux for now  */
#endif
}

/*
...
local void startnewrun(void)
{
    ...
    inputgrav();				/* and external grav field  */
